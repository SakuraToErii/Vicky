...
1. Run `./.venv/bin/python .codex/skills/reset/scripts/reset_wiki.py --scope <scope>` to print the plan.
2. Show the plan to the user.
3. After explicit confirmation, run `./.venv/bin/python .codex/skills/reset/scripts/reset_wiki.py --scope <scope> --yes`.
